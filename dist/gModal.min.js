...
var gModal=function(){function a(a){return a.className.split(" ").filter(function(a){return 0<a.length})}function b(e,b){if(0<=a(e).indexOf(b)){var f=a(e);f.splice(f.indexOf(b),1);e.className=f.join(" ")}}var d={title:"",body:"This is the default body. It can include <strong>html</strong>. You can also leave it empty so we will hide it :).",buttons:[],close:{closable:!0,location:"in",bindKey:27,callback:function(a){a.hide()}},onShow:function(a){},onHide:function(a){a.destroy()},onCreate:function(a){},
onDestroy:function(a){}};"function"!=typeof Object.assign&&(Object.assign=function(a){if(null==a)throw new TypeError("Cannot convert undefined or null to object");a=Object(a);for(var b=1;b<arguments.length;b++){var f=arguments[b];if(null!=f)for(var c in f)Object.prototype.hasOwnProperty.call(f,c)&&(a[c]=f[c])}return a});var c=function(e,g){this.id=g||Math.random().toString(36).substr(2);this.options=Object.assign({},d,e);"undefined"!==typeof e&&"undefined"!==typeof e.close&&(this.options.close=Object.assign({},
...
window.currentModal instanceof c){var b=window.currentModal;if(b.display)for(var h=a.keyCode||a.which,f=Object.keys(b.bindings),d=0;d<f.length;d++)if(f[d]===h)return a.preventDefault(),a.stopPropagation(),b.bindings[f[d]](b),!1}};this.show=function(){if("undefined"!==typeof this.wrapper){var b=this.wrapper;0<=a(b).indexOf("gmodal-active")||(b.className+=" gmodal-active");b=document.body;0<=a(b).indexOf("gmodal-active")||(b.className+=" gmodal-active");this.display=!0;this.options.onShow(this)}};this.hide=
