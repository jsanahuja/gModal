...
(function(a,b){"function"===typeof define&&define.amd?define([],b):"object"===typeof exports?module.exports=b():a.gModal=b()})(this,function(){function a(a){return a.className.split(" ").filter(function(a){return 0<a.length})}function b(c,b){if(0<=a(c).indexOf(b)){var f=a(c);f.splice(f.indexOf(b),1);c.className=f.join(" ")}}var d={title:"",body:"",buttons:[],close:{closable:!0,location:"in",bindKey:27,callback:function(a){a.hide()}},onShow:function(a){},onHide:function(a){a.destroy()},onCreate:function(a){},
onDestroy:function(a){}};return function(c,e){this.id=e||Math.random().toString(36).substr(2);this.options=Object.assign({},d,c);"undefined"!==typeof c&&"undefined"!==typeof c.close&&(this.options.close=Object.assign({},d.close,c.close));this.display=!1;this.bindings={};this.bind=function(a,b){"undefined"!==typeof this.bindings[a]&&console.warn("gModal: Tried to bind the key "+a+" twice. Overriding...");this.bindings[a]=b};this.addKeyListener=function(){window.currentModal=this;window.addEventListener("keydown",
this.onKeyPress,!1)};this.removeKeyListener=function(){window.currentModal=void 0;window.removeEventListener("keydown",this.onKeyPress,!1)};this.onKeyPress=function(a){if("undefined"!==typeof window.currentModal&&window.currentModal instanceof gModal){var b=window.currentModal;if(b.display)for(var c=a.keyCode||a.which,d=Object.keys(b.bindings),f=0;f<d.length;f++)if(parseInt(d[f])===c)return a.preventDefault(),a.stopPropagation(),b.bindings[d[f]](b),!1}};this.show=function(){if("undefined"!==typeof this.wrapper){var b=
this.wrapper;0<=a(b).indexOf("gmodal-active")||(b.className+=" gmodal-active");b=document.body;0<=a(b).indexOf("gmodal-active")||(b.className+=" gmodal-active");this.display=!0;this.options.onShow(this)}};this.hide=function(){"undefined"!==typeof this.wrapper&&(b(this.wrapper,"gmodal-active"),b(document.body,"gmodal-active"),this.display=!1,this.options.onHide(this))};this.create=function(){if("undefined"===typeof this.wrapper){this.wrapper=document.createElement("div");this.wrapper.className="gmodal-wrapper";
this.wrapper.id="gmodal-wrapper-"+this.id;var a=document.createElement("div");a.className="gmodal-backdrop";var b=document.createElement("div");b.className="gmodal-dialog";if("undefined"!==typeof this.options.close.closable&&this.options.close.closable){var c=document.createElement("a");c.setAttribute("href","javascript:void(0);");"undefined"===typeof this.options.close.callback&&(this.options.close.callback=function(){});c.modal=this;c.callback=this.options.close.callback;c.onclick=function(a){a.preventDefault();
a.stopPropagation();this.callback(this.modal);return!1};"number"===typeof this.options.close.bindKey&&this.bind(this.options.close.bindKey,this.options.close.callback);"undefined"===typeof this.options.close.location||"in"==this.options.close.location?(c.className="gmodal-close-in",b.appendChild(c)):(c.className="gmodal-close-out",a.appendChild(c))}""!=this.options.title&&(c=document.createElement("div"),c.className="gmodal-title",c.innerHTML=this.options.title,b.appendChild(c));""!=this.options.body&&
(c=document.createElement("div"),c.className="gmodal-body",c.innerHTML=this.options.body,b.appendChild(c));if(0<this.options.buttons.length){c=document.createElement("div");c.className="gmodal-buttons";for(var d=0;d<this.options.buttons.length;d++){var e=document.createElement("a");e.setAttribute("href","javascript:void(0);");e.className="gmodal-button";"undefined"!==typeof this.options.buttons[d].classes&&(e.className+=" "+this.options.buttons[d].classes);"undefined"!==typeof this.options.buttons[d].content&&
(e.innerHTML=this.options.buttons[d].content);"undefined"===typeof this.options.buttons[d].callback&&(this.options.buttons[d].callback=function(a){a.hide()});e.modal=this;e.callback=this.options.buttons[d].callback;e.onclick=function(a){a.preventDefault();a.stopPropagation();this.callback(this.modal);return!1};"number"===typeof this.options.buttons[d].bindKey&&this.bind(this.options.buttons[d].bindKey,this.options.buttons[d].callback);c.appendChild(e)}b.appendChild(c)}this.wrapper.appendChild(a);
this.wrapper.appendChild(b);document.body.appendChild(this.wrapper);this.addKeyListener();this.options.onCreate(this)}};this.destroy=function(){"undefined"!==typeof this.wrapper&&(document.body.removeChild(this.wrapper),this.wrapper=void 0,this.removeKeyListener(),this.options.onDestroy(this))};this.create()}});