...
m){var a=window.currentModal;if(a.display)for(var b=c.keyCode||c.which,d=Object.keys(a.bindings),e=0;e<d.length;e++)if(d[e]==b)return c.preventDefault(),c.stopPropagation(),a.bindings[d[e]](a),!1}};this.show=function(){if("undefined"!==typeof this.wrapper){var a=this.wrapper;0<=h(a).indexOf("gmodal-active")||(a.className+=" gmodal-active");a=document.body;0<=h(a).indexOf("gmodal-active")||(a.className+=" gmodal-active");this.display=!0;this.options.onShow(this)}};this.hide=function(){"undefined"!==typeof this.wrapper&&
(k(this.wrapper,"gmodal-active"),k(document.body,"gmodal-active"),this.display=!1,this.options.onHide(this))};this.create=function(){if("undefined"===typeof this.wrapper){this.wrapper=document.createElement("div");this.wrapper.className="gmodal-wrapper";this.wrapper.id="gmodal-wrapper-"+this.id;var a=document.createElement("div");a.className="gmodal-backdrop";var f=document.createElement("div");f.className="gmodal-dialog";if("undefined"!==typeof this.options.close.closable&&this.options.close.closable){var b=
...
(b.className="gmodal-close-in",f.appendChild(b)):(b.className="gmodal-close-out",a.appendChild(b))}""!=this.options.title&&(b=document.createElement("div"),b.className="gmodal-title",b.innerHTML=this.options.title,f.appendChild(b));""!=this.options.body&&(b=document.createElement("div"),b.className="gmodal-body",b.innerHTML=this.options.body,f.appendChild(b));if(0<this.options.buttons.length){b=document.createElement("div");b.className="gmodal-buttons";for(var d=0;d<this.options.buttons.length;d++){var e=
